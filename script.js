...
const projects = [
  ...
  },
  {
    ...
    hashtag: ['#HTML', '#CSS', '#ResponsiveWebsite'],
    description: `In this project, I just want mentioning my old project when I still in university (I got bored when I waiting my cousin to finish her school that day). This Website is pretty simple and easy, just build it with HTML and CSS. It also mobile responsive, but not so major, just to adjust itself with any screen sizes.`,
